# ZTM-challenge
ZTM challenge - lecture 164

the js script here solves the below 3 javascript puzzles. 
The goal of this challenge is to practice our logic skills. 

The script is fully commented based on the article : https://medium.freecodecamp.org/how-to-think-like-a-programmer-lessons-in-problem-solving-d1d8bf1de7d2
